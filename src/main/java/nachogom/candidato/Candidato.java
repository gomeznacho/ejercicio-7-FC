...
public class Candidato {
    ...
    public Candidato(int candidatoId, String nombre, String ciudad, String telefono, String email, boolean remoto, Presencialidad presencialidad, int userId, ArrayList<Etiqueta> etiquetas) {
        this.candidatoId = candidatoId;
        this.nombre = nombre;
        this.ciudad = ciudad;
        this.telefono = telefono;
